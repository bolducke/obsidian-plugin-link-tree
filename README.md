...
The tree starts at the active note by default. You can choose any note as a persistent root from the sidebar's search action, quickly pin the active note, or use the **Set current note as root** command. It then has two expandable branches:
